...
const UI = {
    ...
    addSoundHandlers() {
	document.getElementById("paddle_toggle_headphones_button")
	    .addEventListener('click', UI.toggleHeadphones);
	document.getElementById("paddle_toggle_microphone_button")
	    .addEventListener('click', UI.toggleMicrophone);
    },
